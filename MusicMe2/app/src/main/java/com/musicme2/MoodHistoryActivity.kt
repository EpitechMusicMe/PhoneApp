...
class MoodHistoryActivity : AppCompatActivity() ,SeekBar.OnSeekBarChangeListener{
...
//        myArcChartView.setUnFilldeColor(1,Color.LTGRAY)
        ...
        myArcChartView.setSectionIcons(mutableListOf(
                BitmapFactory.decodeResource(this@MoodHistoryActivity.resources,R.drawable.ic_happy_mood),
                BitmapFactory.decodeResource(this@MoodHistoryActivity.resources,R.drawable.ic_excited_mood),
                BitmapFactory.decodeResource(this@MoodHistoryActivity.resources,R.drawable.ic_angry_mood,
                BitmapFactory.decodeResource(this@MoodHistoryActivity.resources,R.drawable.ic_energetic_mood),
                BitmapFactory.decodeResource(this@MoodHistoryActivity.resources,R.drawable.ic_nervous_mood),
                BitmapFactory.decodeResource(this@MoodHistoryActivity.resources,R.drawable.ic_tired_mood),
                BitmapFactory.decodeResource(this@MoodHistoryActivity.resources,R.drawable.ic_nervous_mood),
                BitmapFactory.decodeResource(this@MoodHistoryActivity.resources,R.drawable.ic_bored_mood),
                        BitmapFactory.decodeResource(this@MoodHistoryActivity.resources,R.drawable.ic_sad_mood)
        ))
